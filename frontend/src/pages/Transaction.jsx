  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-6 pb-32">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <div className="md:col-span-5 flex flex-col gap-4">
          ...
          <div className="bg-white custom-shadow rounded-xl border border-[#bccac0] p-4 flex-1 flex flex-col">
            ...
            {previewImage ? (
              ...
              >
                ...
                <h3 className="text-title-sm text-[#0b1c30] mb-1">Quét hóa đơn (Sắp ra mắt)</h3>
                <p className="text-body-md text-[#3d4a42] mb-4">Tự động đọc thông tin từ ảnh</p>
              </div>
            )}
          ...
          <div className="hidden md:flex gap-3">
            <button onClick={handleClear} className="flex-1 bg-[#d3e4fe] text-[#545f73] font-bold py-4 rounded-xl hover:bg-[#bccac0] transition-all active:scale-95">
              Xóa Trắng
            </button>
            <button
      ...
      <div className="md:hidden fixed bottom-16 left-0 w-full p-4 bg-white/90 backdrop-blur-md border-t border-[#bccac0] flex gap-3 z-40">
        <button onClick={handleClear} className="flex-1 bg-[#d3e4fe] text-[#545f73] font-bold py-3 rounded-lg active:scale-95 transition-all">
          Xóa
        </button>
        <button
          onClick={handleSubmit}
